...
test-timings: $(TESTDIR)$(UNITY) $(TESTDIR)$(T_TIME)
	$(CC) $(CFLAGS) src/cpu.c src/debug.c src/emu.c src/mem.c src/stack.c src/instruction.c src/instruction_table.c test/unity.c test/timings.c -o $(OUTDIR)test_timings
	$(OUTDIR)test_timings
